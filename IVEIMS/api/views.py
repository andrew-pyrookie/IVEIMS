...
# Custom Permission Class to allow access based on role (Admin or Staff)
class IsAdminOrStaff(BasePermission):
    def has_permission(self, request, view):
        # Allow access for admin or staff roles
...
class RegisterView(generics.CreateAPIView):
    queryset = Users.objects.all()
    serializer_class = UsersSerializer
    permission_classes = [permissions.AllowAny]  # Open for anyone to register
...
class UserListView(generics.ListAPIView):
    queryset = Users.objects.all()
    serializer_class = UsersSerializer
    permission_classes = [IsAdminOrStaff]  # Only Admin or Staff can view the list of users
