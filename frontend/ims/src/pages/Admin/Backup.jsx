...
//             <th style={{ border: "1px solid black", padding: "8px" }}>File Path</th>
//           </tr>
//         </thead>
//         <tbody>
//           {backupLogs.map((log) => (
//             <tr key={log.id}>
//               <td style={{ border: "1px solid black", padding: "8px" }}>{log.id}</td>
//               <td style={{ border: "1px solid black", padding: "8px" }}>
//                 {new Date(log.date).toLocaleString()}
//               </td>
//               <td style={{ border: "1px solid black", padding: "8px" }}>{log.status}</td>
//               <td style={{ border: "1px solid black", padding: "8px" }}>{log.file_path}</td>
//             </tr>
//           ))}
//         </tbody>
//       </table>
