...
import "/src/pages/Student/styles/CezeriLab.css";
    ...
    <div className="cerazi-lab-container">
      ...
      <div className="main-content">
        ...
        <div className="content-header">
          ...
          <p>View and book equipment in the Cerazi Lab</p>
        </div>
            ...
            <div className="modal-content booking-modal">
              ...
              <div className="booking-equipment-details">
                ...
                <div className="equipment-info">
                  ...
                  <div className="equipment-meta">
                    <span><strong>Status:</strong> {currentItem.status}</span>
                    <span><strong>Lab:</strong> {currentItem.homeLab}</span>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleBookEquipment} className="equipment-form">
                ...
                <div className="availability-indicator">
                  <div className={`availability-dot ${currentItem.status === 'available' ? 'available' : 'booked'}`}></div>
