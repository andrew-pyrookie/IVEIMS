...
var index = typeof document !== "undefined" ? import_react132.useLayoutEffect : import_react132.useEffect;
...
function useLatestRef(value) {
  const ref = (0, import_react132.useRef)(value);
  index(() => {
    ref.current = value;
  });
  return ref;
...
// node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
var FloatingArrow3 = (0, import_react133.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index4) => (0, import_react198.createElement)(
    "div",
    {
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  const [error2, setError] = (0, import_react246.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes28,
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react250.Children.toArray(children).reduce((acc, child, index4, array) => {
    var _a;
    const item = isElement2(child) ? (0, import_react250.cloneElement)(child, {
      ...getStyles2("breadcrumb", { className: (_a = child.props) == null ? void 0 : _a.className }),
      key: index4
    }) : (0, import_react250.createElement)("div", { ...getStyles2("breadcrumb"), key: index4 }, child);
    acc.push(item);
    if (index4 !== array.length - 1) {
      acc.push(
        (0, import_react250.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index4}` }, separator)
      );
    }
    return acc;
  }, []);
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index4) => (0, import_react266.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index4 }));
...
var Swatches = (0, import_react270.forwardRef)(
  ({
    ...
    const colors = data.map((color, index4) => (0, import_react270.createElement)(
      ColorSwatch,
      {
...
function useVirtualizedCombobox({
  ...
  const listId = (0, import_react273.useRef)(null);
  const searchRef = (0, import_react273.useRef)(null);
  const targetRef = (0, import_react273.useRef)(null);
  const focusSearchTimeout = (0, import_react273.useRef)(-1);
  const focusTargetTimeout = (0, import_react273.useRef)(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
  ...
  const getSelectedOptionIndex = (0, import_react273.useCallback)(() => selectedOptionIndex, []);
  return {
    dropdownOpened,
    openDropdown,
    closeDropdown,
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error2, setError] = (0, import_react305.useState)(!src);
...
var index2 = import_react308.useLayoutEffect;
...
var index3 = React15.forwardRef(TextareaAutosize);
  ...
  return (0, import_jsx_runtime265.jsxs)(import_jsx_runtime265.Fragment, { children: [
    (0, import_jsx_runtime265.jsx)(
      Group,
      {
        ...
        __size: size2,
        dir: "ltr",
        children: _value.map((char, index4) => (0, import_react358.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index4) => (0, import_react385.createElement)(
    Curve,
    {
      ...data,
      key: index4,
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index4) => (0, import_react395.createElement)(
    Box,
    {
