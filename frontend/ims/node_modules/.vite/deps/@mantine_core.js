...
function useMantineColorScheme({ keepTransitions } = {}) {
  ...
  const nonce = useMantineStyleNonce();
  const nonceValue = (0, import_react95.useRef)(nonce == null ? void 0 : nonce());
  if (!ctx) {
    throw new Error("[@mantine/core] MantineProvider was not found in tree");
  }
...
var index2 = typeof document !== "undefined" ? import_react114.useLayoutEffect : import_react114.useEffect;
...
var index3 = typeof document !== "undefined" ? import_react115.useLayoutEffect : import_react115.useEffect;
...
var varsResolver5 = createVarsResolver((theme, { size: size3, color }) => ({
  root: {
...
var varsResolver7 = createVarsResolver(
  (theme, { radius, color, gradient, variant, autoContrast, size: size3 }) => {
    ...
    return {
      groupSection: {
        "--section-height": getSize(size3, "section-height"),
        "--section-padding-x": getSize(size3, "section-padding-x"),
        "--section-fz": getFontSize(size3),
...
var CloseIcon = (0, import_react159.forwardRef)(
  ({ size: size3 = "var(--cb-icon-size, 70%)", style, ...others }, ref) => (0, import_jsx_runtime73.jsx)(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var varsResolver9 = createVarsResolver((_, { size: size3, radius, iconSize }) => ({
  root: {
...
var InputClearButton = factory((_props, ref) => {
  ...
  const { size: size3, variant, vars, classNames, styles, ...others } = props;
  ...
  return (0, import_jsx_runtime86.jsx)(
    CloseButton,
    {
      ...
      ref,
      size: size3 || (ctx == null ? void 0 : ctx.size) || "sm",
...
var Input = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime93.jsx)(InputContext, { value: { size: size3 || "sm" }, children: (0, import_jsx_runtime93.jsxs)(
    Box,
    {
      ...getStyles2("wrapper"),
      ...styleProps,
...
var varsResolver21 = createVarsResolver((_, { size: size3, thumbSize }) => ({
  root: {
    "--slider-size": rem(size3),
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index5) => (0, import_react200.createElement)(
    "div",
    {
...
var varsResolver24 = createVarsResolver((theme, { size: size3, color }) => ({
  chevron: {
...
var ComboboxClearButton = (0, import_react221.forwardRef)(
  ({ size: size3, onMouseDown, onClick, onClear, ...others }, ref) => (0, import_jsx_runtime130.jsx)(
    Input.ClearButton,
    {
      ref,
      tabIndex: -1,
...
var varsResolver25 = createVarsResolver((_, { size: size3, dropdownPadding }) => ({
  options: {
          ...
          Box,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime144.jsxs)("div", { ...getStyles2("labelWrapper"), "data-disabled": disabled || void 0, children: [
                ...
                description && (0, import_jsx_runtime144.jsx)(Input.Description, { size: size3, __inheritStyles: false, ...getStyles2("description"), children: description }),
                error2 && typeof error2 !== "boolean" && (0, import_jsx_runtime144.jsx)(Input.Error, { size: size3, __inheritStyles: false, ...getStyles2("error"), children: error2 })
              ] })
            ]
          }
        )
...
var CheckboxGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size3, wrapperProps, children, readOnly, ...others } = useProps("CheckboxGroup", defaultProps59, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime148.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size3 }, children: (0, import_jsx_runtime148.jsx)(
    Input.Wrapper,
    {
      size: size3,
      ref,
  ...
  (theme, { radius, color, gradient, variant, autoContrast, size: size3 }) => {
    ...
    return {
      groupSection: {
        "--section-height": getSize(size3, "section-height"),
        "--section-padding-x": getSize(size3, "section-padding-x"),
        "--section-fz": (size3 == null ? void 0 : size3.includes("compact")) ? getFontSize(size3.replace("compact-", "")) : getFontSize(size3),
        "--section-radius": radius === void 0 ? void 0 : getRadius(radius),
        "--section-bg": color || variant ? colors.background : void 0,
        "--section-color": colors.color,
        "--section-bd": color || variant ? colors.border : void 0
...
var Center = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime168.jsx)(Box, { ref, mod: [{ inline: inline3 }, mod], ...getStyles2("root"), ...others });
});
...
var varsResolver42 = createVarsResolver((_, { radius, size: size3 }) => ({
  root: {
...
var varsResolver43 = createVarsResolver((_, { size: size3, swatchesPerRow }) => ({
  wrapper: {
...
var varsResolver44 = createVarsResolver((_, { size: size3 }) => ({
  eyeDropperIcon: {
...
// node_modules/@mantine/core/esm/components/Container/Container.mjs
var defaultProps84 = {};
var varsResolver45 = createVarsResolver((_, { size: size3, fluid }) => ({
  root: {
...
var varsResolver46 = createVarsResolver((_, { size: size3 }) => ({
  root: {
...
var varsResolver47 = createVarsResolver((theme, { color, variant, size: size3 }) => ({
  root: {
...
var varsResolver48 = createVarsResolver((_, { position, size: size3, offset: offset3 }) => ({
  root: {
...
var Indicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime215.jsxs)(Box, { ref, ...getStyles2("root"), mod: [{ inline: inline3 }, mod], ...others, children: [
...
// node_modules/@mantine/core/esm/components/Kbd/Kbd.mjs
var defaultProps110 = {};
var varsResolver54 = createVarsResolver((_, { size: size3 }) => ({
  root: {
...
var varsResolver55 = createVarsResolver((_, { size: size3, spacing }) => ({
  root: {
...
var MenuTarget = (0, import_react324.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime228.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react324.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react325.useState)(false);
  const close = () => {
    setOpened(false);
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react334.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react334.useState)(getDefaultZIndex("modal"));
...
function useModalsStack(modals) {
  ...
  const [state, setState] = (0, import_react337.useState)(initialState);
  const open = (0, import_react337.useCallback)((modal) => {
    setState((current) => ({ ...current, [modal]: true }));
  }, []);
  const close = (0, import_react337.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: false })),
    []
  );
  const toggle = (0, import_react337.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: !current[modal] })),
    []
  );
  const closeAll = (0, import_react337.useCallback)(() => setState(initialState), []);
  const register = (0, import_react337.useCallback)(
    (modal) => ({
      opened: state[modal],
      onClose: () => close(modal),
      stackId: modal
...
// node_modules/@mantine/core/esm/components/Pill/PillGroup/PillGroup.mjs
var defaultProps128 = {};
var varsResolver58 = createVarsResolver((_, { gap }, { size: size3 }) => ({
  group: {
...
var varsResolver59 = createVarsResolver((_, { radius }, { size: size3 }) => ({
  root: {
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react343.useRef)(null);
  return (0, import_jsx_runtime245.jsx)(PillsInputProvider, { value: { fieldRef, size: size3, disabled, hasError: !!error2, variant }, children: (0, import_jsx_runtime245.jsx)(
    InputBase,
    {
      size: size3,
      error: error2,
...
var NativeSelect = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime249.jsx)(
    InputBase,
    {
      ...
      error: error2,
      unstyled,
      rightSection: rightSection || (0, import_jsx_runtime249.jsx)(ComboboxChevron, { size: size3, error: error2, unstyled }),
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react349.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react349.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react349.useState)(function() {
  ...
  (0, import_react349.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react349.useRef)();
  var lastUpdatedValue = (0, import_react349.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react349.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react349.useRef)(null);
  var timeout = (0, import_react349.useRef)({
    setCaretTimeout: null,
    focusTimeout: null
  });
  (0, import_react349.useEffect)(function() {
    setMounted(true);
    return function() {
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react349.useLayoutEffect : import_react349.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react349.default.createElement(import_react349.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react349.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react349.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react349.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react349.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
var NumberInput = factory((_props, ref) => {
  ...
  const onStepTimeoutRef = (0, import_react351.useRef)(null);
  const stepCountRef = (0, import_react351.useRef)(0);
  ...
  const incrementRef = (0, import_react351.useRef)(noop);
  ...
  const decrementRef = (0, import_react351.useRef)(noop);
...
function createEdgeComponent({ icon, name, action, type }) {
  ...
  const Component = (0, import_react355.forwardRef)((props, ref) => {
...
var varsResolver64 = createVarsResolver((_, { size: size3 }) => ({
  root: {
...
var varsResolver65 = createVarsResolver((_, { size: size3 }) => ({
  root: {
    "--pin-input-size": getSize(size3 ?? defaultProps143.size, "pin-input-size")
  }
}));
var PinInput = factory((props, ref) => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react359.useState)(-1);
  ...
  const inputsRef = (0, import_react359.useRef)([]);
  const validate = (code) => {
  ...
  return (0, import_jsx_runtime265.jsxs)(import_jsx_runtime265.Fragment, { children: [
    (0, import_jsx_runtime265.jsx)(
      Group,
      {
        ...
        __size: size3,
        dir: "ltr",
        children: _value.map((char, index5) => (0, import_react359.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size3, wrapperProps, children, name, readOnly, ...others } = useProps("RadioGroup", defaultProps149, props);
  ...
  return (0, import_jsx_runtime274.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size3, name: _name }, children: (0, import_jsx_runtime274.jsx)(
    Input.Wrapper,
    {
      size: size3,
      ref,
...
var varsResolver70 = createVarsResolver((theme, { size: size3, color }) => ({
  root: {
...
var Rating = factory((_props, ref) => {
  ...
  const _name = useId(name);
  const _id = useId(id);
  const rootRef = (0, import_react374.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: 0,
  ...
  const [hovered, setHovered] = (0, import_react374.useState)(-1);
  const [isOutside, setOutside] = (0, import_react374.useState)(true);
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react375.useState)(defaultOpened);
  const boundaryRef = (0, import_react375.useRef)(null);
  ...
  const handleMouseMove = (0, import_react375.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime283.jsxs)(import_jsx_runtime283.Fragment, { children: [
    ...
    (0, import_react377.cloneElement)(children, {
      ..._childrenProps,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var TooltipGroupContext = (0, import_react378.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react378.useContext)(TooltipGroupContext);
...
function getTooltipMiddlewares(settings) {
  ...
  const middlewares = [offset2(settings.offset)];
  if (middlewaresOptions.shift) {
    middlewares.push(
      shift2(
  ...
  middlewares.push(arrow2({ element: settings.arrowRef, padding: settings.arrowOffset }));
  if (middlewaresOptions.inline) {
    middlewares.push(
      typeof middlewaresOptions.inline === "boolean" ? inline2() : inline2(middlewaresOptions.inline)
    );
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react381.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const onChange = (0, import_react381.useCallback)(
    (_opened) => {
...
var Tooltip = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const arrowRef = (0, import_react383.useRef)(null);
  ...
  return (0, import_jsx_runtime285.jsxs)(import_jsx_runtime285.Fragment, { children: [
    ...
    (0, import_react383.cloneElement)(
      children,
...
var varsResolver73 = createVarsResolver(
  (_, { size: size3, thickness, transitionDuration }) => ({
    root: {
      "--rp-size": rem(size3),
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset3 }, index5) => (0, import_react386.createElement)(
    Curve,
    {
      ...data,
      key: index5,
  ...
  return (0, import_jsx_runtime287.jsxs)(Box, { ...getStyles2("root"), size: size3, ref, ...others, children: [
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [parent, setParent] = (0, import_react387.useState)(null);
  const [refs, setRefs] = (0, import_react387.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react387.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react387.createElement)(
      "input",
      {
        ...getStyles2("input"),
...
var Select = factory((_props, ref) => {
  ...
  const parsedData = (0, import_react388.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react388.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue, controlled] = useUncontrolled({
    value,
    defaultValue,
...
var SemiCircleProgress = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime290.jsxs)(Box, { ref, size: size3, ...getStyles2("root"), ...others, children: [
    ...
    (0, import_jsx_runtime290.jsxs)("svg", { width: size3, height: size3 / 2, ...getStyles2("svg"), children: [
...
var SliderRoot = (0, import_react394.forwardRef)(
...
var Thumb3 = (0, import_react395.forwardRef)(
  ({
    max: max2,
    min: min2,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react395.useState)(false);
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset3, inverted }) {
  ...
  const items = marks.map((mark, index5) => (0, import_react396.createElement)(
    Box,
    {
...
var Slider = factory((_props, ref) => {
  ...
  const thumb = (0, import_react398.useRef)(null);
  const position = getPosition({ value: _value, min: min2, max: max2 });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react398.useCallback)(
    ({ x }) => {
      if (!disabled) {
...
var RangeSlider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react399.useState)(-1);
  ...
  const thumbs = (0, import_react399.useRef)([]);
  const thumbIndex = (0, import_react399.useRef)(void 0);
  const positions = [
  ...
  return (0, import_jsx_runtime300.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime300.jsxs)(SliderRoot, { ...others, size: size3, ref, disabled, children: [
...
var Stepper = factory((_props, ref) => {
  ...
  const convertedChildren = import_react405.Children.toArray(children);
  ...
  const items = _children.reduce(
    (acc, item, index5) => {
      ...
      acc.push(
        (0, import_react405.cloneElement)(item, {
      ...
      if (orientation === "horizontal" && index5 !== _children.length - 1) {
        acc.push(
          (0, import_react405.createElement)(
            "div",
            {
  ...
  return (0, import_jsx_runtime306.jsx)(StepperProvider, { value: { getStyles: getStyles2, orientation, iconPosition }, children: (0, import_jsx_runtime306.jsxs)(Box, { ...getStyles2("root"), ref, size: size3, ...others, children: [
...
var SwitchGroupContext = (0, import_react406.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react406.useContext)(SwitchGroupContext);
...
var SwitchGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size3, wrapperProps, children, readOnly, ...others } = useProps("SwitchGroup", defaultProps169, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime307.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size3 }, children: (0, import_jsx_runtime307.jsx)(
    Input.Wrapper,
    {
      size: size3,
      ref,
...
var varsResolver82 = createVarsResolver((theme, { radius, color, size: size3 }) => ({
  root: {
...
var varsResolver85 = createVarsResolver(
  (theme, { color, size: size3, variant, autoContrast, depthOffset, radius }) => {
    const colors = theme.variantColorResolver({
      color: color || theme.primaryColor,
      theme,
      variant: variant || "filled",
...
var Timeline = factory((_props, ref) => {
  ...
  const _children = import_react425.Children.toArray(children);
  const items = _children.map(
    (item, index5) => {
      var _a, _b;
      return (0, import_react425.cloneElement)(item, {
        unstyled,
        __align: align,
...
var varsResolver89 = createVarsResolver((_, { order, size: size3, lineClamp, textWrap }) => {
...
function TreeNode({
  ...
  const ref = (0, import_react428.useRef)(null);
...
function useTree({
  ...
  const [data, setData] = (0, import_react431.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react431.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react431.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react431.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react431.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react431.useState)(null);
  const initialize = (0, import_react431.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react431.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react431.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expand = (0, import_react431.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expandAllNodes = (0, import_react431.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react431.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react431.useCallback)(
  ...
  const select = (0, import_react431.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react431.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react431.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react431.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react431.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react431.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react431.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var Tree = factory((_props, ref) => {
  ...
  const flatValues = (0, import_react432.useMemo)(() => getFlatValues(data), [data]);
