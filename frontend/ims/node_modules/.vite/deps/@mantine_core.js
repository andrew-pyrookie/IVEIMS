...
import {
  ...
  shift,
  size
} from "./chunk-E5FSIDCT.js";
import {
  _extends,
  _objectWithoutPropertiesLoose
} from "./chunk-5CAAWDDR.js";
import {
  require_jsx_runtime
...
var index2 = typeof document !== "undefined" ? import_react132.useLayoutEffect : import_react132.useEffect;
...
var index3 = typeof document !== "undefined" ? import_react133.useLayoutEffect : import_react133.useEffect;
...
function useLatestRef2(value) {
  const ref = (0, import_react133.useRef)(value);
  index3(() => {
    ref.current = value;
  });
  return ref;
...
// node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
var FloatingArrow3 = (0, import_react134.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
function FocusTrap({
  ...
  return (0, import_react141.cloneElement)(children, { [refProp]: ref });
}
...
var PopoverTarget = factory((props, ref) => {
  ...
  return (0, import_react144.cloneElement)(children, {
    ...forwardedProps,
    ...accessibleProps,
    ...ctx.targetProps,
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react145.useState)(0);
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react151.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsxs)(Box, { component: "span", className: clsx_default(classes7.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react152.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime67.jsxs)(Box, { component: "span", className: clsx_default(classes7.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react153.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime68.jsx)(Box, { component: "span", className: clsx_default(classes7.ovalLoader, className), ...others, ref }));
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime92.jsx)(import_react181.Fragment, { children: inputContainer(children) }, "input");
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index5) => (0, import_react199.createElement)(
    "div",
    {
...
var ComboboxEventsTarget = factory((props, ref) => {
  ...
  return (0, import_react225.cloneElement)(children, {
    ...targetProps,
    ...others,
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react232.cloneElement)(children, {
    ...targetProps,
    ...others
  });
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react251.Children.toArray(children).reduce((acc, child, index5, array) => {
    var _a;
    const item = isElement2(child) ? (0, import_react251.cloneElement)(child, {
...
var Thumb2 = (0, import_react266.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime175.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const layers = overlays.map((overlay, index5) => (0, import_react267.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index5 }));
...
var Swatches = (0, import_react271.forwardRef)(
  ({
    ...
    const colors = data.map((color, index5) => (0, import_react271.createElement)(
      ColorSwatch,
      {
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react272.useRef)(format2);
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react292.useRef)(-1);
  const closeTimeout = (0, import_react292.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react292.useEffect)(() => clearTimeouts, []);
...
var HoverCardTarget = (0, import_react303.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime211.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react303.cloneElement)(
    children,
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error2, setError] = (0, import_react306.useState)(!src);
...
function useModalsStack(modals) {
  ...
  const [state, setState] = (0, import_react336.useState)(initialState);
  const open = (0, import_react336.useCallback)((modal) => {
    setState((current) => ({ ...current, [modal]: true }));
  }, []);
  const close = (0, import_react336.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: false })),
    []
  );
  const toggle = (0, import_react336.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: !current[modal] })),
    []
  );
  const closeAll = (0, import_react336.useCallback)(() => setState(initialState), []);
  const register = (0, import_react336.useCallback)(
    (modal) => ({
      opened: state[modal],
      onClose: () => close(modal),
      stackId: modal
  ...
  return (0, import_jsx_runtime265.jsxs)(import_jsx_runtime265.Fragment, { children: [
    (0, import_jsx_runtime265.jsx)(
      Group,
      {
        ...
        __size: size3,
        dir: "ltr",
        children: _value.map((char, index5) => (0, import_react358.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset3 }, index5) => (0, import_react385.createElement)(
    Curve,
    {
      ...data,
      key: index5,
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset3, inverted }) {
  ...
  const items = marks.map((mark, index5) => (0, import_react395.createElement)(
    Box,
    {
